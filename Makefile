...
OBJS := boot.o interrupts.o interrupts_c.o kernel.o terminal.o terminal_backspace.o keyboard.o shell.o pmm.o heap.o process.o process_asm.o usermode.o usermode_asm.o tss.o zinit.o
